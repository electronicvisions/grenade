...
CEREAL_REGISTER_TYPE(grenade::vx::signal_flow::vertex::transformation::Concatenation)
CEREAL_REGISTER_POLYMORPHIC_RELATION(
    grenade::vx::signal_flow::vertex::Transformation::Function,
    grenade::vx::signal_flow::vertex::transformation::Concatenation)
EXPLICIT_INSTANTIATE_CEREAL_SERIALIZE(
    grenade::vx::signal_flow::vertex::transformation::Concatenation)
CEREAL_CLASS_VERSION(grenade::vx::signal_flow::vertex::transformation::Concatenation, 0)
