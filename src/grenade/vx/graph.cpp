...
void CEREAL_SAVE_FUNCTION_NAME(
    Archive& ar, grenade::vx::Graph::execution_instance_map_type const& data)
{
	std::vector<std::pair<
	    grenade::vx::Graph::vertex_descriptor, grenade::vx::coordinate::ExecutionInstance>>
	    values;
...
template <class Archive>
void CEREAL_LOAD_FUNCTION_NAME(Archive& ar, grenade::vx::Graph::execution_instance_map_type& data)
{
	std::vector<std::pair<
	    grenade::vx::Graph::vertex_descriptor, grenade::vx::coordinate::ExecutionInstance>>
	    values;
...
template <class Archive>
void CEREAL_SAVE_FUNCTION_NAME(
    Archive& ar, grenade::vx::Graph::vertex_descriptor_map_type const& data)
{
	std::vector<
	    std::pair<grenade::vx::Graph::vertex_descriptor, grenade::vx::Graph::vertex_descriptor>>
	    values;
...
template <class Archive>
void CEREAL_LOAD_FUNCTION_NAME(Archive& ar, grenade::vx::Graph::vertex_descriptor_map_type& data)
{
	std::vector<
	    std::pair<grenade::vx::Graph::vertex_descriptor, grenade::vx::Graph::vertex_descriptor>>
	    values;
...
template <class Archive>
void CEREAL_SAVE_FUNCTION_NAME(Archive& ar, grenade::vx::Graph::graph_type const& data)
{
	...
	std::map<grenade::vx::Graph::vertex_descriptor, int> indices;
	int num = 0;
...
template <class Archive>
void CEREAL_LOAD_FUNCTION_NAME(Archive& ar, grenade::vx::Graph::graph_type& data)
{
	int num_vertices;
	int num_edges;
	ar(CEREAL_NVP(num_vertices));
	...
	std::vector<grenade::vx::Graph::vertex_descriptor> vertices(num_vertices);
	int i = 0;
...
CEREAL_CLASS_VERSION(grenade::vx::Graph, 0)
