...
UncalibratedSignedSynapse::ParameterSpace::Parameterization::Parameterization(
    std::vector<Weight> weights) :
    weights(std::move(weights))
{
}

size_t UncalibratedSignedSynapse::ParameterSpace::Parameterization::size() const
{
	return weights.size();
}

std::unique_ptr<grenade::common::Projection::Synapse::ParameterSpace::Parameterization>
UncalibratedSignedSynapse::ParameterSpace::Parameterization::get_section(
...
UncalibratedSignedSynapse::ParameterSpace::Parameterization::copy() const
{
	return std::make_unique<UncalibratedSignedSynapse::ParameterSpace::Parameterization>(*this);
}

std::unique_ptr<grenade::common::PortData>
UncalibratedSignedSynapse::ParameterSpace::Parameterization::move()
{
	return std::make_unique<UncalibratedSignedSynapse::ParameterSpace::Parameterization>(
	    std::move(*this));
}

bool UncalibratedSignedSynapse::ParameterSpace::Parameterization::is_equal_to(
    grenade::common::PortData const& other) const
{
	return weights ==
	       static_cast<UncalibratedSignedSynapse::ParameterSpace::Parameterization const&>(other)
	           .weights;
}

std::ostream& UncalibratedSignedSynapse::ParameterSpace::Parameterization::print(
...
UncalibratedSignedSynapse::ParameterSpace::ParameterSpace(std::vector<Weight> max_weights) :
    max_weights(max_weights)
{
}

size_t UncalibratedSignedSynapse::ParameterSpace::size() const
{
	return max_weights.size();
}

bool UncalibratedSignedSynapse::ParameterSpace::valid(
    ...
    const
{
	...
	if (auto const ptr = dynamic_cast<Parameterization const*>(&parameterization); ptr) {
		...
		for (size_t i = 0; i < max_weights.size(); ++i) {
			if (std::abs(ptr->weights.at(i)) > max_weights.at(i)) {
				return false;
			}
		}
		return true;
...
UncalibratedSignedSynapse::ParameterSpace::get_section(
    grenade::common::MultiIndexSequence const& sequence) const
{
...
std::unique_ptr<grenade::common::Projection::Synapse::ParameterSpace>
UncalibratedSignedSynapse::ParameterSpace::copy() const
{
	return std::make_unique<UncalibratedSignedSynapse::ParameterSpace>(*this);
}

std::unique_ptr<grenade::common::Projection::Synapse::ParameterSpace>
UncalibratedSignedSynapse::ParameterSpace::move()
{
	return std::make_unique<UncalibratedSignedSynapse::ParameterSpace>(std::move(*this));
}

bool UncalibratedSignedSynapse::ParameterSpace::is_equal_to(
    grenade::common::Projection::Synapse::ParameterSpace const& other) const
{
	return max_weights ==
	       static_cast<UncalibratedSignedSynapse::ParameterSpace const&>(other).max_weights;
}

std::ostream& UncalibratedSignedSynapse::ParameterSpace::print(std::ostream& os) const
{
	hate::IndentingOstream ios(os);
	ios << "ParameterSpace(\n";
	ios << hate::Indentation("\t");
...
UncalibratedSignedSynapse::UncalibratedSignedSynapse(
    grenade::common::ReceptorOnCompartment excitatory_receptor,
    grenade::common::ReceptorOnCompartment inhibitory_receptor) :
    excitatory_receptor(excitatory_receptor), inhibitory_receptor(inhibitory_receptor)
{
}

bool UncalibratedSignedSynapse::valid(
...
bool UncalibratedSignedSynapse::valid(
    size_t, grenade::common::Projection::Synapse::Dynamics const&) const
{
	return false;
}
...
bool UncalibratedSignedSynapse::requires_time_domain() const
{
	return true;
}

bool UncalibratedSignedSynapse::is_partitionable() const
{
	return true;
}

UncalibratedSignedSynapse::Ports UncalibratedSignedSynapse::get_input_ports() const
{
	Ports ret;
...
UncalibratedSignedSynapse::Ports UncalibratedSignedSynapse::get_output_ports() const
{
	Ports ret;
	ret.projection.push_back(grenade::common::Vertex::Port(
	    ...
	    grenade::common::Vertex::Port::RequiresOrGeneratesData::no,
	    grenade::common::ListMultiIndexSequence(
	        {grenade::common::MultiIndex({excitatory_receptor}),
	         grenade::common::MultiIndex({inhibitory_receptor})},
...
std::unique_ptr<grenade::common::Projection::Synapse> UncalibratedSignedSynapse::copy() const
{
	return std::make_unique<UncalibratedSignedSynapse>(*this);
}

std::unique_ptr<grenade::common::Projection::Synapse> UncalibratedSignedSynapse::move()
{
	return std::make_unique<UncalibratedSignedSynapse>(std::move(*this));
}

bool UncalibratedSignedSynapse::is_equal_to(grenade::common::Projection::Synapse const& other) const
{
	auto const& other_synapse = static_cast<UncalibratedSignedSynapse const&>(other);
	return excitatory_receptor == other_synapse.excitatory_receptor &&
	       inhibitory_receptor == other_synapse.inhibitory_receptor;
}

std::ostream& UncalibratedSignedSynapse::print(std::ostream& os) const
{
	os << "UncalibratedSignedSynapse(excitatory: " << excitatory_receptor
	   << ", inhibitory: " << inhibitory_receptor << ")";
	return os;
}
