...
std::pair<PlasticityRule::TimedRecordingConfig, PlasticityRule::Parameterization>
OnlyRecordingPlasticityRuleGenerator::generate() const
{
	...
	PlasticityRule::Parameterization parameterization(kernel.str());
	return {recording, parameterization};
}
