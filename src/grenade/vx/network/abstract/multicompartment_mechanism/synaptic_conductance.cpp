    ...
    CompartmentOnNeuron const& compartment, Environment const& environment) const
{
	...
	std::vector<detail::PropertyHolder<HardwareResource>> resource_list;
	std::vector<detail::PropertyHolder<HardwareConstraint>> constraint_list;
	...
	std::vector<detail::PropertyHolder<SynapticInputEnvironment>> synaptic_inputs =
