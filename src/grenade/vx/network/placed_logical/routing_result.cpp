...
std::ostream& operator<<(
    std::ostream& os,
    grenade::vx::network::placed_logical::RoutingResult::PlacedConnection const& connection)
{
...
std::ostream& operator<<(
    std::ostream& os, grenade::vx::network::placed_logical::RoutingResult const& result)
{
	os << "Connections:\n";
