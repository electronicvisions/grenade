...
grenade::common::ExecutionInstanceID SingleChipExecutionInstanceManager::next()
{
	using namespace halco::hicann_dls::vx::v3;
	if (m_current_hemisphere) {
		m_current_instance = grenade::common::ExecutionInstanceID(m_current_instance + 1);
	}
...
grenade::common::ExecutionInstanceID SingleChipExecutionInstanceManager::next_index()
{
