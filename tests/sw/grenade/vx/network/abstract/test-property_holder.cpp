...
struct DummyProperty : public grenade::vx::network::Property<DummyProperty>
{};
...
TEST(PropertyHolder, General)
{
	...
	grenade::vx::network::detail::PropertyHolder<DummyProperty> holder_5(derived_dummy_5);
	...
	grenade::vx::network::detail::PropertyHolder<DummyProperty> holder_7(
	    std::move(derived_dummy_7));
