...
#include "grenade/vx/network/placed_atomic/detail/source_on_padi_bus_manager.h"
#include "grenade/vx/network/placed_atomic/detail/source_on_padi_bus_manager.tcc"
#include "halco/common/iter_all.h"
#include "lola/vx/v3/synapse.h"


using namespace grenade::vx::network::placed_atomic::detail;
...
TEST(detail_SourceOnPADIBusManager, get_allocation_requests_internal)
{
	...
	std::vector<grenade::vx::network::placed_atomic::SynapseDriverOnDLSManager::AllocationRequest>
	    expectation{
...
TEST(detail_SourceOnPADIBusManager, get_allocation_requests_external)
{
	...
	grenade::vx::network::placed_atomic::SynapseDriverOnDLSManager::AllocationRequest expectation{
	    {{PADIBusOnDLS(Enum(2)), {{12, false}}}}, {}, std::nullopt};
