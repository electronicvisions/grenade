...
#include "grenade/vx/network/placed_atomic/detail/synapse_driver_on_dls_manager.h"
...
TEST(detail_SynapseDriverOnDLSManager, update_solution)
{
	...
	std::vector<grenade::vx::network::placed_atomic::SynapseDriverOnPADIBusManager::Allocation>
	    local_solution{
	        {{{}}},
	        {{{}}},
	    };
		...
		std::vector<SynapseDriverOnDLSManager::Allocation> solution{
		    {{{PADIBusOnDLS(Enum(0)),
		       {{{{SynapseDriverOnPADIBus(0),
		           grenade::vx::network::placed_atomic::SynapseDriverOnPADIBusManager::Mask()},
