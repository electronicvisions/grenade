...
#include "grenade/vx/network/placed_atomic/routing/detail/synapse_driver_on_dls_manager.h"
...
TEST(detail_SynapseDriverOnDLSManager, update_solution)
{
	...
	std::vector<
	    grenade::vx::network::placed_atomic::routing::SynapseDriverOnPADIBusManager::Allocation>
	    local_solution{
	        {{{}}},
	        {{{}}},
	    };
...
TEST(detail_SynapseDriverOnDLSManager, valid_solution)
{
	...
	// not contiguous
	{
		...
		std::vector<SynapseDriverOnDLSManager::Allocation> solution{
		    {{{PADIBusOnDLS(Enum(0)),
		       {{{{SynapseDriverOnPADIBus(0), grenade::vx::network::placed_atomic::routing::
		                                          SynapseDriverOnPADIBusManager::Mask()},
		          {SynapseDriverOnPADIBus(2), grenade::vx::network::placed_atomic::routing::
		                                          SynapseDriverOnPADIBusManager::Mask()}}}}}},
		     SynapseDriverOnDLSManager::Label(2)}};
		EXPECT_FALSE(SynapseDriverOnDLSManager::valid_solution(solution, requested_allocations));
	}
	// valid
	{
		...
		std::vector<SynapseDriverOnDLSManager::Allocation> solution{
		    {{{PADIBusOnDLS(Enum(0)),
		       {{{{SynapseDriverOnPADIBus(0), grenade::vx::network::placed_atomic::routing::
		                                          SynapseDriverOnPADIBusManager::Mask()},
		          {SynapseDriverOnPADIBus(1), grenade::vx::network::placed_atomic::routing::
		                                          SynapseDriverOnPADIBusManager::Mask()}}}}}},
		     SynapseDriverOnDLSManager::Label(2)}};
