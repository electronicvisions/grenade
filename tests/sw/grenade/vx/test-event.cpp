...
{
	TimedSpike spike(
	    TimedSpike::Time(123), haldls::vx::v3::SpikePack1ToChip({haldls::vx::v3::SpikeLabel(456)}));
	...
	EXPECT_EQ(
	    ...
	    haldls::vx::v3::SpikePack1ToChip({haldls::vx::v3::SpikeLabel(456)}));

	TimedSpike spike_other = spike;
	spike_other.time = TimedSpike::Time(321);
	EXPECT_NE(spike, spike_other);
	spike_other.time = spike.time;
	spike_other.payload = haldls::vx::v3::SpikePack1ToChip({haldls::vx::v3::SpikeLabel(654)});
	EXPECT_NE(spike, spike_other);
