...
TEST(Addition, Single)
{
	...
	grenade::vx::signal_flow::vertex::Transformation addition(
	    grenade::vx::signal_flow::vertex::transformation::Addition(2, size),
	...
	auto const v1 = topology->add_vertex(addition);
	...
	// run mapped topology with given inputs and return results
