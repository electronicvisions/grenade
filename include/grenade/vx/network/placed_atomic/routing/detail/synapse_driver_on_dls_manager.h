...
{
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnDLSManager::Label Label;
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnDLSManager::SynapseDriver
	    SynapseDriver;
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnDLSManager::
	    AllocationRequest AllocationRequest;
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnDLSManager::Allocation
	    Allocation;
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnDLSManager::
