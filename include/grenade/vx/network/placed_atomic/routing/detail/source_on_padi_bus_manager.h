#pragma once
#include "grenade/vx/network/placed_atomic/routing/source_on_padi_bus_manager.h"
...
{
	typedef grenade::vx::network::placed_atomic::routing::SourceOnPADIBusManager::Label Label;
	typedef grenade::vx::network::placed_atomic::routing::SourceOnPADIBusManager::SynapseDriver
	    SynapseDriver;
	typedef grenade::vx::network::placed_atomic::routing::SourceOnPADIBusManager::InternalSource
	    InternalSource;
	typedef grenade::vx::network::placed_atomic::routing::SourceOnPADIBusManager::BackgroundSource
	    BackgroundSource;
	typedef grenade::vx::network::placed_atomic::routing::SourceOnPADIBusManager::ExternalSource
	    ExternalSource;
	typedef grenade::vx::network::placed_atomic::routing::SourceOnPADIBusManager::Partition
	    Partition;
