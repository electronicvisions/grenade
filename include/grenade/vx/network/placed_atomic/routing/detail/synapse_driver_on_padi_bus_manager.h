#pragma once
#include "grenade/vx/network/placed_atomic/routing/synapse_driver_on_padi_bus_manager.h"
...
{
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnPADIBusManager::Label
	    Label;
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnPADIBusManager::Mask Mask;
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnPADIBusManager::
	    SynapseDriver SynapseDriver;
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnPADIBusManager::
	    AllocationRequest AllocationRequest;
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnPADIBusManager::Allocation
	    Allocation;
	typedef grenade::vx::network::placed_atomic::routing::SynapseDriverOnPADIBusManager::
