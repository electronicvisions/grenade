#pragma once
#include "grenade/vx/network/placed_atomic/source_on_padi_bus_manager.h"
...
{
	typedef grenade::vx::network::placed_atomic::SourceOnPADIBusManager::Label Label;
	typedef grenade::vx::network::placed_atomic::SourceOnPADIBusManager::SynapseDriver
	    SynapseDriver;
	typedef grenade::vx::network::placed_atomic::SourceOnPADIBusManager::InternalSource
	    InternalSource;
	typedef grenade::vx::network::placed_atomic::SourceOnPADIBusManager::BackgroundSource
	    BackgroundSource;
	typedef grenade::vx::network::placed_atomic::SourceOnPADIBusManager::ExternalSource
	    ExternalSource;
	typedef grenade::vx::network::placed_atomic::SourceOnPADIBusManager::Partition Partition;
