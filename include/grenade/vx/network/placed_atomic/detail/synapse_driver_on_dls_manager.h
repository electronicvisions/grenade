...
{
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnDLSManager::Label Label;
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnDLSManager::SynapseDriver
	    SynapseDriver;
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnDLSManager::AllocationRequest
	    AllocationRequest;
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnDLSManager::Allocation Allocation;
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnDLSManager::AllocationPolicy
	    AllocationPolicy;
