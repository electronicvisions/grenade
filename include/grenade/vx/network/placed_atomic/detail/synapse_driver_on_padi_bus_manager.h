#pragma once
#include "grenade/vx/network/placed_atomic/synapse_driver_on_padi_bus_manager.h"
...
{
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnPADIBusManager::Label Label;
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnPADIBusManager::Mask Mask;
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnPADIBusManager::SynapseDriver
	    SynapseDriver;
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnPADIBusManager::AllocationRequest
	    AllocationRequest;
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnPADIBusManager::Allocation
	    Allocation;
	typedef grenade::vx::network::placed_atomic::SynapseDriverOnPADIBusManager::AllocationPolicy
	    AllocationPolicy;
