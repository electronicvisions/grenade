#pragma once
#include "grenade/vx/network/placed_logical/routing/synapse_driver_on_padi_bus_manager.h"
...
{
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnPADIBusManager::Label
	    Label;
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnPADIBusManager::Mask Mask;
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnPADIBusManager::
	    SynapseDriver SynapseDriver;
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnPADIBusManager::
	    AllocationRequest AllocationRequest;
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnPADIBusManager::Allocation
	    Allocation;
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnPADIBusManager::
