...
{
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnDLSManager::Label Label;
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnDLSManager::SynapseDriver
	    SynapseDriver;
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnDLSManager::
	    AllocationRequest AllocationRequest;
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnDLSManager::Allocation
	    Allocation;
	typedef grenade::vx::network::placed_logical::routing::SynapseDriverOnDLSManager::
