...
namespace grenade::vx::network::placed_logical::routing::detail {

struct SourceOnPADIBusManager
{
	typedef grenade::vx::network::placed_logical::routing::SourceOnPADIBusManager::Label Label;
	typedef grenade::vx::network::placed_logical::routing::SourceOnPADIBusManager::SynapseDriver
	    SynapseDriver;
	typedef grenade::vx::network::placed_logical::routing::SourceOnPADIBusManager::InternalSource
	    InternalSource;
	typedef grenade::vx::network::placed_logical::routing::SourceOnPADIBusManager::BackgroundSource
	    BackgroundSource;
	typedef grenade::vx::network::placed_logical::routing::SourceOnPADIBusManager::ExternalSource
	    ExternalSource;
	typedef grenade::vx::network::placed_logical::routing::SourceOnPADIBusManager::Partition
	    Partition;
