...
GENPYBIND_MANUAL({
	auto cls =
	    pybind11::class_<::grenade::vx::network::placed_logical::RoutingOptions::AllocationPolicy>(
	        parent, "_RoutingOptions_AllocationPolicy");
	cls.def(
	       pybind11::init<::grenade::vx::network::placed_logical::routing::
	                          SynapseDriverOnDLSManager::AllocationPolicyGreedy>(),
	       pybind11::arg("value") = ::grenade::vx::network::placed_logical::routing::
	           SynapseDriverOnDLSManager::AllocationPolicyGreedy())
	    .def(
	        pybind11::init<::grenade::vx::network::placed_logical::routing::
