...
/**
 * Map from PoissonSourceNeuron population to BackgroundSpikeSource(s).
 */
struct PoissonSourceNeuronMapping : public grenade::common::InterTopologyHyperEdge
{
	PoissonSourceNeuronMapping(
